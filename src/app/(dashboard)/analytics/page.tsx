...
export default async function AnalyticsPage() {
  ...
  if (!roleAtLeast(role, 'amateur')) return <PlanGate requiredPlan="amateur" featureName="Analíticas" featureDescription="Visualiza estadísticas de tu criadero, perros y camadas." />
