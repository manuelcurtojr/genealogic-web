...
export default async function EmbudoPage() {
  ...
  const { data: entries } = await supabase
    ...
    .select(
      'id, applicant_name, applicant_email, applicant_phone, applicant_message, preference_sex, created_at, status, pipeline_id, stage_id, seen_by_breeder_at, lost_reason, client_user_id, origin_entry_id',
    )
