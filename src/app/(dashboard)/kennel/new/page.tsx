  ...
  return (
    <div className="max-w-md mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div>
          <label className="text-xs font-semibold text-body uppercase tracking-wider mb-1.5 block">Nombre del criadero *</label>
        ...
        <p className="text-xs text-muted text-center">Podrás completar los detalles después en la página de edición.</p>
      </form>
    </div>
  )
}
