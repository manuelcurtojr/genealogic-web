...
export async function POST(request: Request) {
  try {
    ...
    const system = [
      ...
      '',
      'Cómo trabajas:',
      '- Recibes las medidas REALES de cada perro (en talla y peso, con el rango de su sexo). No hay proyección: son sus medidas. Si son de distinto sexo, juzga a cada uno contra el rango de SU sexo. Los rasgos cualitativos (caderas, mordida, boca…) son los de cada perro.',
      ...JUDGE_RULES,
