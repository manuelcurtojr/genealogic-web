    ...
    <div className="min-h-screen bg-gray-950 flex items-center justify-center px-4 relative">
      ...
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-white/50 text-sm">Crea tu cuenta</p>
        </div>
        ...
        <form onSubmit={handleRegister} className="space-y-4">
          ...
          <div>
            <label className="text-xs font-semibold text-white/50 uppercase tracking-wider mb-1.5 block">Nombre</label>
