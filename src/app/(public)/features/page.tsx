...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: t('Producto'),
    description: t(
      'Todo lo que tu criadero necesita: pipeline de reservas, genealogía interactiva, salud y analítica. Explora cada herramienta con mockups del producto real.'
    ),
    alternates: { canonical: 'https://www.genealogic.io/features' },
    openGraph: {
      title: t('El producto Genealogic'),
      description: t('Pipeline · Genealogía · Salud · Stats. Mira cómo se ven antes de probarlas.'),
      ...
      <section className="relative overflow-hidden border-b border-hairline bg-gradient-to-br from-orange-50/50 via-canvas to-blue-50/40">
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 py-14 sm:py-20 relative">
          ...
          <p className="mt-4 text-[15px] sm:text-[17px] text-body leading-snug max-w-2xl">
            {t('Tu genealogía completa, el importador con IA y el perfil público de tu criadero, indexable en Google y listo desde el día 1. Y vamos soltando herramientas nuevas cada poco. Mira cómo se ven antes de empezar.')}
          </p>
