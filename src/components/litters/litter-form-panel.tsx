...
export default function LitterFormPanel({ open, onClose, editLitterId, userId }: LitterFormPanelProps) {
  ...
  return (
    <>
      <div className={`fixed inset-0 z-40 bg-black/50 backdrop-blur-[2px] transition-opacity duration-300 ${open ? 'opacity-100' : 'opacity-0 pointer-events-none'}`} onClick={onClose} />
