  ...
  return (
    <div className="max-w-xl">
      <div className="flex items-center gap-4 mb-8">
        <Link href={isEdit ? `/litters/${initialData.id}` : '/litters'} className="text-muted hover:text-ink transition">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex items-center justify-between bg-surface-card border border-hairline rounded-lg p-4">
          <div>
            ...
            <p className="text-xs text-muted mt-0.5">Visible para otros usuarios</p>
          </div>
