...
export const CATEGORIES: Category[] = [
    ...
    features: [
      ...
      },
      {
        ...
        bullets: [
          ...
          'Hasta 5 generaciones en una sola página A4',
          'Logo del criadero + firma + sello digital',
          'QR de verificación con link al perfil público',
  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    featurettes: [
      ...
      { icon: ShieldCheck, title: 'Certificados verificables', description: 'QR público que enlaza al PDF del laboratorio.' },
