...
export default function CookieBanner() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-[300] bg-gray-900 border-t border-white/10 px-4 py-4 sm:px-6">
      <div className="max-w-4xl mx-auto flex flex-col sm:flex-row items-start sm:items-center gap-3">
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          <button onClick={reject} className="text-xs text-white/40 hover:text-white px-3 py-2 transition">
            Rechazar
          </button>
