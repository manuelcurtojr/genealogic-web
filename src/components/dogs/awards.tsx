...
const AWARD_TYPES = [
  ...
  { key: 'other', label: 'Otro', color: 'bg-surface-card text-body' },
] as const
    ...
    <div>
      <div className="space-y-2">
        {awards.map(award => {
          ...
          return (
            <div key={award.id} className="bg-surface-card border border-hairline rounded-lg p-4 flex items-center gap-3">
