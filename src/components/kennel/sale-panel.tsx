          ...
          <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-5">
            ...
            <div className="flex items-center gap-3 bg-white/[0.03] border border-white/5 rounded-xl p-3">
              <div className="w-14 h-14 rounded-lg overflow-hidden bg-white/5 flex-shrink-0">
                {dog.thumbnail_url ? <img src={dog.thumbnail_url} alt="" className="w-full h-full object-cover" /> : <div className="w-full h-full flex items-center justify-center"><Dog className="w-6 h-6 text-white/15" /></div>}
              </div>
              <div>
              ...
              <>
                ...
                <div className="bg-white/[0.02] border border-white/5 rounded-xl p-4 space-y-3">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    ...
                    <div>
                      <label className="text-[11px] font-semibold text-white/50 uppercase tracking-wider mb-1 block">Precio total</label>
                    ...
                    <div>
                      <label className="text-[11px] font-semibold text-white/50 uppercase tracking-wider mb-1 block">Reserva</label>
                ...
                <div className="bg-white/[0.02] border border-white/5 rounded-xl p-4 space-y-3">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    <div>
                      <label className="text-[11px] font-semibold text-white/50 uppercase tracking-wider mb-1 block">Ciudad, Pais</label>
                ...
                {/* Description */}
                <div>
                  <label className="text-[11px] font-semibold text-white/50 uppercase tracking-wider mb-1 block">Descripcion del anuncio</label>
