...
export const ACHIEVEMENT_DEFS: Omit<Achievement, 'unlocked'>[] = [
  ...
  { key: 'explorador',      title: 'Explorador',        label: 'Explorador',   icon: 'Compass',         color: '#6366F1', desc: 'Añade perros de 3 o mas razas diferentes.' },
  ...
  { key: 'salud_primero',   title: 'Salud Primero',    label: 'Salud',        icon: 'HeartPulse',      color: '#EF4444', desc: 'Añade el primer registro veterinario.' },
